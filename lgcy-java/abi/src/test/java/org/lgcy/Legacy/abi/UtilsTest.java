...
import org.lgcy.Legacy.abi.datatypes.Fixed;
...
import static org.lgcy.Legacy.abi.Utils.typeMap;
...
public class UtilsTest {
    ...
    public void testTypeMapEmpty() {
        assertEquals(Utils.typeMap(new ArrayList<>(), Uint256.class), (new ArrayList<Uint256>()));
    }
}
